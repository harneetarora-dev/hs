...
const navItems: NavItem[] = [
  ...
  },
  {
    label: "Quotes",
    href: "/quotes",
    roles: ["owner", "merchant", "supervisor"],
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    label: "Orders",
    href: "/orders",
    roles: ["owner", "merchant", "supervisor", "contractor"],
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    roles: ["owner", "designer", "merchant", "supervisor"],
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="p-4 border-t border-border">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 min-w-0">
            <div className="w-8 h-8 rounded-full bg-surface flex items-center justify-center text-sm font-medium text-primary flex-shrink-0">
